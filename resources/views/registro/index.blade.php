    ...
    <div class="col-md-4 p-5 shadow-sm border rounded-3">
        ...
        <form method="POST" action="{{'/register'}}">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control border border-primary" id="correo" name="correo">
            </div>
            <div class="mb-3">
                <label for="inputPassword" class="form-label">Contraseña</label>
                <input type="password" class="form-control border border-primary" id="contrasena" name="contrasena">
            </div>
            <div class="mb-3">
                <label for="inputPassword2" class="form-label">Repite tu contraseña</label>
                <input type="password" class="form-control border border-primary" id="contrasena2" name="contrasena2">
            </div>
            <div class="d-grid">
